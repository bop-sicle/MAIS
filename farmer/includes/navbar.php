...
?>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFarm"
                    aria-expanded="true" aria-controls="collapseAcc">
                    <i class="fas fa-fw fa-solid fa-house-chimney"></i>
                    <span>My Farm</span>
                </a>
                <div id="collapseFarm" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Marketplace</h6>
                    <a class="collapse-item" href="harvest.php">
                        <i class="fas fa-solid fa-wheat-awn fa-fw mr-2 text-gray-400"></i>
                        Harvest
                    </a>
                    <a class="collapse-item" href="livestock.php">
                        <i class="fas fa-solid fa-cow fa-fw mr-2 text-gray-400"></i>
                        Livestock
                    </a>
                    </div>
                </div>
            ...
            <!-- <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseMarket"
                    aria-expanded="true" aria-controls="collapseAcc">
                    <i class="fas fa-fw fa-solid fa-map-location-dot"></i>
                    <span>Marketplace</span>
                </a>
                <div id="collapseMarket" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Marketplace</h6>
                    <a class="collapse-item" href="marketplace.php">
                        <i class="fas fa-solid fa-map fa-fw mr-2 text-gray-400"></i>
                        Shop Now
                    </a>
                    <a class="collapse-item" href="#">
                        <i class="fas fa-solid fa-location-dot fa-fw mr-2 text-gray-400"></i>
                        My Cart
                    </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMap" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="map.php">
                        <i class="fas fa-solid fa-map fa-fw mr-2 text-gray-400"></i>
                        View Map
                    </a>
                    <a class="collapse-item" href="my_location.php">
                        <i class="fas fa-solid fa-location-dot fa-fw mr-2 text-gray-400"></i>
                        My Location
                    </a>
                    </div>
