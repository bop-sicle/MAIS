...
?>
                ...
                <div class="container-fluid">   
                    ...
                    <div class="modal fade" id="viewloan<?php echo $row['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
